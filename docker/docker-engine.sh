...
echo $prefix_download_dir/$containerd | xargs sudo dpkg -i -y
echo $prefix_download_dir/$docker_ce | xargs sudo dpkg -i -y
echo $prefix_download_dir/$docker_ce_cli | xargs sudo dpkg -i -y
echo $prefix_download_dir/$docker_buildx | xargs sudo dpkg -i -y
echo $prefix_download_dir/$docker_compose | xargs sudo dpkg -i -y
